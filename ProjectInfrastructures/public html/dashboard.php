	...
	<body>
		<nav>
			<div class="button-selection">
				...
				<button type="button" id="button-selection-option-snowfall" onclick="sownFall();" class="button-selection-option"><span class="fas fa-snowflake"></span> Snowfall</button>
